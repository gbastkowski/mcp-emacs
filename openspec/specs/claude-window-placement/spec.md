...
Deterministic placement of the Claude Code buffer: a configurable-width,
weakly-dedicated, normal (non-side) splittable window, with the width clamped
to a maximum fraction of the frame so the code pane is not crushed on narrow
frames.
