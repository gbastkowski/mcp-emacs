...
Define the mutating MCP capability for updating an Org task session through its live Emacs buffer: setting session and item status, appending progress notes and new items without clobbering human content, and leaving save decisions to the human.
